...
setwd("~/Dropbox/Data/2016 Data/CTD 2016/ASCII/FCR30")
files = list.files(path = "~/Dropbox/Data/2016 Data/CTD 2016/ASCII/FCR30") # This reads all the files into the R environment
...
fcr30_layers <- arrange(df.final, date)

write.csv(fcr30_layers[,c(1,2,3,4,5,7,8,9)], "FCR_site30_layers_2016.csv", row.names=FALSE)
